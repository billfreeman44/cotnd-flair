...
output_namearr.append('Aqwos')
output_steam_id.append('76561198147679362')
output_altarr.append('')
output_version.append('none')

output_namearr.append('Piper1618')
output_steam_id.append('76561198107217526')
output_altarr.append('')
output_version.append('none')

output_namearr.append('BlueAura74')
output_steam_id.append('76561198120331550')
output_altarr.append('')
output_version.append('none')

output_namearr.append('vlatkosh')
output_steam_id.append('76561198252203614')
output_altarr.append('')
output_version.append('none')

output_namearr.append('bladynator')
output_steam_id.append('76561198049471418')
output_altarr.append('')
output_version.append('none')

output_namearr.append('Revalize')
output_steam_id.append('76561198055098680')
output_altarr.append('')
output_version.append('none')

output_namearr.append('I_Like_Tau')
output_steam_id.append('76561198136201511')
output_altarr.append('')
output_version.append('none')

output_namearr.append('innateshelf')
output_steam_id.append('76561198069040913')
output_altarr.append('')
output_version.append('none')

output_namearr.append('Minhs2')
output_steam_id.append('76561198040828497')
output_altarr.append('')
output_version.append('none')


output_namearr.append('PM_ME_CAKE')
output_steam_id.append('76561198083937398')
output_altarr.append('')
output_version.append('none')
